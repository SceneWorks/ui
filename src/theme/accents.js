// @sceneworks/ui — user-selectable accent palettes (story sc-7219, epic 7217).
//
// Extracted VERBATIM from SceneWorks apps/web/src/styles.css's accents.js. Each
// entry maps to a `[data-accent="<id>"]` block in theme.css that sets the accent
// + secondary hue; the light/dark ramps in :root / [data-theme="dark"] consume
// those hues, so flipping the attribute recolors the whole app. `swatch` is the
// dot shown in the topbar picker. "teal" is the default brand accent.
