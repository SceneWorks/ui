...
//
// EXTRACTION NOTE (story sc-7220): the SceneWorks original rendered the thumbnail
// via <AssetThumbnail> from apps/web's assetMedia.jsx, which is app-specific (it
// resolves media URLs against the SceneWorks API). To keep @sceneworks/ui
// app-agnostic, thumbnail rendering is now injected: pass `renderThumbnail(asset)`
// to draw the thumbnail (SceneWorks passes its AssetThumbnail). Everything else is
// byte-for-byte the SceneWorks component.
